...
const Tableline = ({ coin, index }) => {
    ...
    const mktCapFormater = (num) => {
        // je fait un tableau(split) et j'enleve les 6 derniers chiffre (slice (-6))
                    ...
                    <a
                        href={
                            ...
                            coin.name
                                ...
                                .replace(" ", "-")
                                .replace(" ", "-")
                            // replace car certain s'appele luna Classique y'a un espace
                        }
                        target="_blank"
